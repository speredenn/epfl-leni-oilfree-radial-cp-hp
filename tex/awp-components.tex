...
provided with the heat exchangers and an operational air ducting and
...
\begin{itemize}
\item Main vapor lines diameter: 3/4 inch;
\item Liquid lines diameter: 1/2 inch;
\item Liquid/Vapor lines: 1/2 inch;
...
SER series from \citet{sporlan-ser-2015a}.
...
already been designed using the biggest possible volume, with respect
...
male union parts\footnotep{Serto male metric union M5 SO-41124-2-M5,
  ...
  workshop. They were adapted, then, to the Serto fittings.}. \Cref{fig:awp-electromagnetic-perturbation-P} illustrates what is
observed on \cref{fig:awp-sh-too-low-ev-sh-with-plate}.

\begin{figure}
  \centering
  \includegraphics[width=8cm]{DSCF0219}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=8cm]{awp-magnetic-perturbation-02}
